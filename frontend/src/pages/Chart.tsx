...
export default function UsageChart() {
  ...
  const getUsageModel = async () => {
    const [resGemini, resOllama] = await Promise.all([
      getUsageGemini(),
      getUsageOllama(),
    ]);

    const dataUsageModel = [
      { model: resGemini.data.model, token: resGemini.data.total_tokens },
      { model: resOllama.data.model, token: resOllama.data.total_tokens },
    ];
    const totalToken: number =
      resGemini.data.total_tokens + resOllama.data.total_tokens;
